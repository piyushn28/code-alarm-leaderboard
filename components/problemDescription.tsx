...
const ProblemDescription: React.FC<ProblemDescriptionProps> = () => {
  return (
    <div className="bg-dark-layer-1">
      ...
      <div className="flex w-full gap-8 px-10 h-14 bg-dark-layer-2 items-center text-xs  font-medium text-[#eff1f6bf]">
        <div className="flex items-center border-b-[2px] border-[#B3B3B3] h-full text-white">
          Description
        </div>
        ...
        <div className="px-5">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center mt-3">
              <div
                className={`text-white bg-green-600 inline-block rounded-[21px] px-2.5 py-1 text-xs font-medium capitalize `}
              >
                Easy
              </div>
